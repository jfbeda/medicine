...
\begin{itemize}
    \item Increased risk of \hyperref[cond:c-diff]{\textit{c. diff}} infection
\end{itemize}
...
After injury, arachidonic acid is released from the cells, which is converted to prostaglandins by COX (Cyclooxygenase) which lead to pain. \cite[10:--]{CobboldPepticUlcerDisease}
...
NSAID use increases the risk of peptic ulcers as follows \cite[11:--]{CobboldPepticUlcerDisease}. In the stomach, prostaglandins are continuously produced from arachidonic acid, and stimulate the production of mucus and bicarbonate, and help with epithelial cell repair. NSAID consumption then inhibits prostaglandin production and has some knock-on effects. 