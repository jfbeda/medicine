...
\subsection{Anatomical resources}

\begin{itemize}
	\item \href{https://commons.wikimedia.org/wiki/Scrollable_computed_tomography_images_of_a_normal_abdomen_and_pelvis}{Scrollable axial CT}
...
\subsection{Cells of the stomach}
\begin{table}[htbp]
    \centering
    \footnotesize
    ...
    \begin{tabularx}{\textwidth}{
        ...
        Gastric parietal cells & Releases gastric acid and intrinsic factor & Fundus and body of the stomach\\

        G-cells & Release gastrin &Primarily in the antrum\\

        D-cells & Produce somatostatin & Stomach/intestine/pancreatic islets\\

        ECL-like cells & Produce histamine & Entire stomach\\

        EC cells & Produce serotonin & Whole digestive tract\\

        P/D1 cells & Produce ghrelin & The fundus\\

        Chief cells & Releases pepsinogen and gastric lipase & The stomach\\
        \bottomrule
    \end{tabularx}

    \caption{Gastrointestinal cell types.}
    \label{tab:cells_of_stomach}
\end{table}

\subsection{Hormones of the Stomach}
\begin{table}[htbp]
    \centering
    \footnotesize
    \setlength{\tabcolsep}{3pt}
    ...
    \begin{tabularx}{\textwidth}{
        ...
        \textbf{Effect} &
        \textbf{Released by} &
        \textbf{Release induced by} \\
        \midrule

        Gastrin &
        \(\uparrow\) HCl release by stimulating parietal cells and stimulating ECL-like cells to release histamine. &
        G cells &
        --- \\

        Histamine &
        \(\uparrow\) HCl release by binding to receptors on parietal cells. &
        ECL-like cells &
        --- \\          

        Somatostatin &
         \(\downarrow\) HCl release and \(\downarrow\) gastrin release. &
        D cells &
        Low pH (high acidity) \\

        Serotonin &
        Regulates GI motility and fluid secretion. &
        EC cells &
        --- \\

        Ghrelin &
        Increases appetite and promotes fat storage. &
        P/D1 cells &
        --- \\
    ...
    \caption{Gastrointestinal signalling substances and their effects.}
    \label{tab:gi-signalling}
\end{table}

Note that CCK (cholecystokinin) is released by I cells in the duodenum and jejunum.
